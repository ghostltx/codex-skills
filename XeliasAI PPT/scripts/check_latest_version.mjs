...
const REMOTE_PACKAGE_URL = 'https://raw.githubusercontent.com/chuspeeism/xeliasai-ppt-skill/main/project/package.json';
...
async function main() {
  ...
  process.stdout.write(
    `发现 XeliasAI PPT 新版本 ${remoteVersion}（当前 ${localVersion}）。建议更新：重新拉取 https://github.com/chuspeeism/xeliasai-ppt-skill 后替换本地 XeliasAI PPT。\n`
  );
}
