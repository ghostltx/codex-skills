# XeliasAI PPT Skill · Web Decks / Per-Page Console / Editable PPTX Export

![GitHub stars](https://img.shields.io/github/stars/chuspeeism/xeliasai-ppt-skill?style=flat-square)
...
![Generated deck demo](https://github.com/chuspeeism/xeliasai-ppt-skill/releases/download/readme-assets-v1/hero-result.gif)
...
用 XeliasAI PPT 直接生成 PPT 格式的文件（跳过网页，直接交付可编辑 PPTX）。
(Use XeliasAI PPT to generate a PPT file directly — skip the web deck, deliver an editable PPTX.)
```
...
![Page-by-page comparison of HTML deck and exported PPTX](https://github.com/chuspeeism/xeliasai-ppt-skill/releases/download/readme-assets-v1/html-vs-pptx.gif)
...
> Install the `XeliasAI PPT` skill for me. Follow these steps:
>
> 1. Make sure the `~/.claude/skills/` directory exists (create it if not; Codex users: `~/.codex/skills/`)
> 2. Run `git clone https://github.com/chuspeeism/xeliasai-ppt-skill.git "~/.claude/skills/XeliasAI PPT"`
> 3. Verify: `ls "~/.claude/skills/XeliasAI PPT/"` should show `SKILL.md`, `project/`, `references/`, `scripts/`
...
```bash
# Claude Code
git clone https://github.com/chuspeeism/xeliasai-ppt-skill.git "~/.claude/skills/XeliasAI PPT"

# Codex
git clone https://github.com/chuspeeism/xeliasai-ppt-skill.git "~/.codex/skills/XeliasAI PPT"
```
...
- "用 XeliasAI PPT 生成 PPT 格式的文件" — "Use XeliasAI PPT to generate a PPT file"

## How It Works

Drop in whatever document you have and say you want a deck (the agent discovers this skill on its own — or name `XeliasAI PPT` to force it), then wait a few minutes for a complete deck:
...
![One-click image fill for placeholders](https://github.com/chuspeeism/xeliasai-ppt-skill/releases/download/readme-assets-v1/image-placeholder.gif)
...
|---|---|
| ![Click text to edit in place; decorative elements adapt to text length](https://github.com/chuspeeism/xeliasai-ppt-skill/releases/download/readme-assets-v1/text-edit.gif) | ![Insert an image into a page](https://github.com/chuspeeism/xeliasai-ppt-skill/releases/download/readme-assets-v1/add-image.gif) |
...
|---|---|
| ![Drag sliders to adjust TOC, table, multi-item, and image counts](https://github.com/chuspeeism/xeliasai-ppt-skill/releases/download/readme-assets-v1/slider-edit.gif) | ![Switch a page layout in one sentence](https://github.com/chuspeeism/xeliasai-ppt-skill/releases/download/readme-assets-v1/layout-switch.gif) |

| Swap charts | Palette switching within a theme |
|---|---|
| ![Swap chart types in one sentence](https://github.com/chuspeeism/xeliasai-ppt-skill/releases/download/readme-assets-v1/chart-switch.gif) | ![Each theme supports local palette swaps](https://github.com/chuspeeism/xeliasai-ppt-skill/releases/download/readme-assets-v1/palette-switch.gif) |
...
![Page transition animations](https://github.com/chuspeeism/xeliasai-ppt-skill/releases/download/readme-assets-v1/transitions.gif)
...
![Tour of chart layouts](https://github.com/chuspeeism/xeliasai-ppt-skill/releases/download/readme-assets-v1/layouts-tour.gif)
...
![Built-in analysis framework layouts](https://github.com/chuspeeism/xeliasai-ppt-skill/releases/download/readme-assets-v1/analysis-models.png)

The high-frequency staples — TOC, table, big-number poster, and image-text pages:

![Common layouts](https://github.com/chuspeeism/xeliasai-ppt-skill/releases/download/readme-assets-v1/common-layouts.png)
...
![One-click export to editable PPT](https://github.com/chuspeeism/xeliasai-ppt-skill/releases/download/readme-assets-v1/export-pptx.gif)
...
```bash
npm --prefix "~/.claude/skills/XeliasAI PPT/project" run export:pptx -- <deck-output-dir>/ppt output.pptx
npm --prefix "~/.claude/skills/XeliasAI PPT/project" run export:pdf  -- <deck-output-dir>/ppt
```
