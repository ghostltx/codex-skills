...
export function DeckPageNumber({
  ...
  return (
    <Tag
      ...
      className={className}
      style={style}
      data-xeliasai-page-number="fraction"
      data-xeliasai-page-pad={pad}
      data-xeliasai-page-total-pad={totalPad}
      data-xeliasai-page-separator={separator}
      data-editable-skip="true"
    >
      <b data-xeliasai-page-current="" style={{ ...(accentStyle || {}), ...(currentStyle || {}) }}>{page}</b>
      <span data-xeliasai-page-separator="true">{separator}</span>
      <span data-xeliasai-page-total="" style={totalStyle}>{total}</span>
    </Tag>
  );
}
...
export function DeckPageCurrent({
  ...
  return (
    <Tag
      ...
      className={className}
      style={style}
      data-xeliasai-page-number="current"
      data-xeliasai-page-pad={pad}
      data-editable-skip="true"
    >
      <span data-xeliasai-page-current="">{value}</span>
    </Tag>
  );
}
