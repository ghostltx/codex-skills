...
(() => {
  ...
  const STORAGE_PREFIX = 'xeliasai-ppt-image-slots';
  ...
  class ImageSlot extends HTMLElement {
    ...
    // bindRenderedImageSlots' 'xeliasai-image-slot-change' listener + JAD-MEDIA01
    // defaultProps declarations across theme04's slides).
    _notifyHost(value) {
      if (!this.id) return;
      this.dispatchEvent(new CustomEvent('xeliasai-image-slot-change', {
        bubbles: true,
        composed: true,
