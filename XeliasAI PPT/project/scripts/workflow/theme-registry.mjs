...
function readManifest() {
  ...
  if (!existsSync(file)) {
    console.warn(
      '[xeliasai-ppt] layout-manifest.json not found; falling back to live contracts derived from theme metadata. '
  ...
  try {
    ...
    console.warn(
      `[xeliasai-ppt] layout-manifest.json is present but could not be parsed (${error.message}); `
