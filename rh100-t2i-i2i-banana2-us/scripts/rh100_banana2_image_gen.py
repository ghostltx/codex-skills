...
T2I_URL = f"{BASE_URL}/rhart-image-n-g31-flash-official/text-to-image"
...
def main():
    parser = argparse.ArgumentParser(
        description="RH100 US Nano Banana 2 fast submit client; auto-routes text-to-image/image-to-image and opens the bill-task page"
    )
