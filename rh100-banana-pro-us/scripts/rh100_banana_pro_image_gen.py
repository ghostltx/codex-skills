...
T2I_URL = f"{BASE_URL}/rhart-image-n-pro-official/text-to-image"
I2I_URL = f"{BASE_URL}/rhart-image-n-g31-flash-official/image-to-image"
...
def main():
    parser = argparse.ArgumentParser(
        description="RH100 US Banana PRO fast submit client; auto-routes text-to-image/composition image-to-image and opens the bill-task page"
    )
    ...
    if len(image_urls) > 14:
        raise SystemExit("imageUrls supports at most 14 images.")
