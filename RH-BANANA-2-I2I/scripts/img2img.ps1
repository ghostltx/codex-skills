# RunningHub Banana 2 image-to-image helper.
...
$DefaultWorkflowId = "2043515543696707586"
...
function New-DefaultOutputPath {
    ...
    return (Join-Path $desktop "runninghub_banana2_i2i_$timestamp.png")
}
...
$promptNodeId = "12"
$imageNodeIds = @("2", "13", "14", "15", "16", "21", "20", "19", "18", "17")
if (-not [string]::IsNullOrWhiteSpace($Quality)) {
    Write-Warning "Ignoring -Quality for the Banana 2 I2I workflow; the provided workflow JSON does not expose a quality field."
    $Quality = ""
}

Write-Host "RunningHub Banana 2 I2I"
